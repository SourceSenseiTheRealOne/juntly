 ...
 */
export const getReadiness = <ThrowOnError extends boolean = false>(options?: Options<GetReadinessData, ThrowOnError>) => (options?.client ?? client).get<GetReadinessResponses, GetReadinessErrors, ThrowOnError>({ url: '/api/v1/ready', ...options });
 ...
 */
export const createBookingReview = <ThrowOnError extends boolean = false>(options: Options<CreateBookingReviewData, ThrowOnError>) => (options.client ?? client).post<CreateBookingReviewResponses, CreateBookingReviewErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const listMyProviderReviews = <ThrowOnError extends boolean = false>(options?: Options<ListMyProviderReviewsData, ThrowOnError>) => (options?.client ?? client).get<ListMyProviderReviewsResponses, ListMyProviderReviewsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const respondToReview = <ThrowOnError extends boolean = false>(options: Options<RespondToReviewData, ThrowOnError>) => (options.client ?? client).put<RespondToReviewResponses, RespondToReviewErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getProviderRating = <ThrowOnError extends boolean = false>(options: Options<GetProviderRatingData, ThrowOnError>) => (options.client ?? client).get<GetProviderRatingResponses, GetProviderRatingErrors, ThrowOnError>({ url: '/api/v1/public/providers/{providerId}/rating', ...options });

/**
 * List active administrator-configured plans and promotion periods.
 */
export const getEntitlementCatalog = <ThrowOnError extends boolean = false>(options?: Options<GetEntitlementCatalogData, ThrowOnError>) => (options?.client ?? client).get<GetEntitlementCatalogResponses, GetEntitlementCatalogErrors, ThrowOnError>({ url: '/api/v1/entitlements/catalog', ...options });

/**
 * Read server-owned provider access, subscription, and promotions.
 */
export const getMyEntitlements = <ThrowOnError extends boolean = false>(options?: Options<GetMyEntitlementsData, ThrowOnError>) => (options?.client ?? client).get<GetMyEntitlementsResponses, GetMyEntitlementsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const requestSubscription = <ThrowOnError extends boolean = false>(options: Options<RequestSubscriptionData, ThrowOnError>) => (options.client ?? client).post<RequestSubscriptionResponses, RequestSubscriptionErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const requestListingPromotion = <ThrowOnError extends boolean = false>(options: Options<RequestListingPromotionData, ThrowOnError>) => (options.client ?? client).post<RequestListingPromotionResponses, RequestListingPromotionErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getAdministrationDashboard = <ThrowOnError extends boolean = false>(options?: Options<GetAdministrationDashboardData, ThrowOnError>) => (options?.client ?? client).get<GetAdministrationDashboardResponses, GetAdministrationDashboardErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const moderateAdministrativeTarget = <ThrowOnError extends boolean = false>(options: Options<ModerateAdministrativeTargetData, ThrowOnError>) => (options.client ?? client).post<ModerateAdministrativeTargetResponses, ModerateAdministrativeTargetErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
